...
\item Ex ore infántium et lacténtium perfecísti laudem propter ini\textit{mícos} \textbf{tu}os,~* ut déstruas inimí\textit{cum} \textit{et} \textit{ul}\textbf{tó}rem.
...
\item Inveniátur manus tua ómnibus ini\textit{mícis} \textbf{tu}is:~* déxtera tua invéniat omnes, \textit{qui} \textit{te} \textit{o}\textbf{dé}runt.
...
\item Recordátus est quóniam pulvis sumus:~† homo, sicut fœnum di\textit{es} \textbf{e}jus,~* tamquam flos agri sic \textit{efflo}\textbf{ré}bit.
