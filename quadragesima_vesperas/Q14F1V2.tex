...
{\centering\includegraphics[scale=1.2]{quad1.jpg}\par}

\vfill

\newpage

\smalltitle{Capitule --- premier dimanche}
...
\smalltitle{Capitule --- deuxième dimanche}
...
\smalltitle{Capitule --- troisième dimanche}
...
\smalltitle{Capitule --- quatrième dimanche}
...
\rubric{Premier et troisième dimanche: voir page suivante.\\Deuxième et quatrième dimanche: voir page d'après.}
\newpage
\smalltitle{Antienne à Magnificat --- premier dimanche}
...
\smalltitle{Antienne à Magnificat --- troisième dimanche}
...
\smalltitle{Antienne à Magnificat --- deuxième dimanche}
...
\smalltitle{Antienne à Magnificat --- quatrième dimanche}

\gscore{Q4AM}{A}{}
\translation{Jésus monta donc sur une montagne, et là il s’assit avec ses disciples.}

\smalltitle{Magnificat du premier ton}
\smallscore{magn1}
\vspace{\baselineskip}
\magnificat{1}
...
\smalltitle{Oraison -- premier dimanche}

\oratio{Deus, qui Ecclésiam tuam ánnua quadragesimáli observatióne puríficas:~\pscross{} præsta famíliæ tuæ; ut, quod a te obtinére abstinéndo nítitur,~\psstar{} hoc bonis opéribus exsequátur. Per Dóminum.}{Dieu, qui purifiez votre Église par l’observance annuelle du Carême : aidez votre famille, afin que, ce qu’elle s’efforce d’obtenir de vous par l’abstinence, elle le réalise en bonnes œuvres.}

\smalltitle{Oraison -- deuxième dimanche}
...
\smalltitle{Oraison -- troisième dimanche}
...
\smalltitle{Oraison -- quatrième dimanche}
