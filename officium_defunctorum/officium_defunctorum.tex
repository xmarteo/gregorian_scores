...
%% \modeannotation converts a number (1-8) into the corresponding roman numeral to be printed as annotation,
\newcommand{\modeannotation}[1]{
  \greannotation{\IfInteger{#1}{\Rnum{#1}}{#1}}
}
...
\newcommand{\gscore}[4][y]{
  ...
  \greannotation[c]{\officepartannotation{#3}#4}
  \ifx y#1\grechangedim{spaceabovelines}{\neumespace}{scalable}\null \vspace*{0.8\neumespace}\fi
  \gregorioscore{partitions/#2}
  \ifx y#1\grechangedim{spaceabovelines}{0mm}{scalable}\fi
}
...
Édition préparée par Matthias Bry, Dominique Crochu,\\Giedrius Gapsys et Anne Guyard\\
Neumes de l'antiphonaire de Hartker, Codex Sangallensis 391, ff. 195-200\\
...
\addcontentsline{toc}{section}{Vêpres}
...
\smalltitle{Cantique de la Bienheureuse Vierge Marie}
\smallscore[n]{VPM}
\psalmtext{m}
\smallscore{VAM}
...
\begin{parcolumns}[rulebetween]{2}%
	\colchunk{%
		\vv Pater noster. \rubric{En silence jusqu'à}\\
...
\begin{parcolumns}[rulebetween]{2}%
	\colchunk{%
		...
		\vv Requiésca\bracketed{n}t in pace.\\
		\rr Amen.\\
		\vv Dómine, exáudi oratiónem meam.\\
		\rr Et clamor meus ad te véniat.\\
		\bracketed{\vv Dóminus vobíscum.\\
	...
	\colchunk{%
		...
		\vv Qu'il\bracketed{s} repose\bracketed{nt} en paix.\\
		\rr Amen.\\
		\vv Seigneur, entends ma prière.\\
		\rr Et que mon cri parvienne jusqu'à Toi.\\
		\bracketed{\vv Le Seigneur soit avec vous.\\
...
\addcontentsline{toc}{subsection}{Oraisons à la fin des offices}
...
\begin{parcolumns}[rulebetween]{2}%
	\colchunk{%
Absólve, quǽsumus Dómine, ánimam fámuli tui \bracketed{fámulæ tuæ} N., ut defúnctus \bracketed{defúncta} sǽculo tibi vívat : † et quæ per fragilitátem carnis humána conversatióne commísit,~\psstar{} tu vénia misericordíssimæ pietátis abstérge. Per Dóminum.
	}
	\colchunk{%
...
Inclína Dómine aurem tuam ad preces nostras, quibus misericórdiam tuam súpplices deprecámur :~† ut ánimam fámuli tui N., quam de hoc sǽculo migráre jussísti, in pacis ac lucis regióne constítuas,~\psstar{} et sanctórum tuórum júbeas esse consórtem. Per Dóminum.
	...
	\colchunk{%
Seigneur, prête l'oreille à nos prières, par lesquelles nous implorons humblement Ta miséricorde, afin que Tu introduises dans le séjour de la paix et de la lumière l'âme de Ton serviteur N., que Tu as retirée de cette terre, et que Tu l'admettes dans la société de Tes saints.
	}
\end{parcolumns}
...
\addcontentsline{toc}{subsection}{Premier Nocturne, les dimanche, lundi et jeudi}
...
\gscore{MA3}{A}{3}
~\\
\trans{\aa Qu'ils ne m'égorgent pas, tous ces fauves, ne me déchirent pas, sans que personne ne me délivre.}
\psalmus{7}{MP3}
\pagebreak
\smallscore{MA3}
...
~\\
\rubric{\normaltext{Pater noster} entièrement en silence.\\Les leçons sont chantées sans absolution, ni bénédiction, ni conclusion.}

\lesson{1}{Première leçon}{Job 7 : 16-21\\~}
...
\lesson{2}{Deuxième leçon}{Job 10 : 1-7}
...
\lesson{3}{Troisième leçon}{Job 10 : 8-12}
...
\addcontentsline{toc}{subsection}{Deuxième Nocturne, les mardi et vendredi}
...
\lesson{4}{Quatrième leçon}{Job 13 : 22-28}
...
\lesson{5}{Cinquième leçon}{Job 14 : 1-6}
...
\lesson{6}{Sixième leçon}{Job 14 : 13-16}
...
\addcontentsline{toc}{subsection}{Troisième Nocturne, les mercredi et samedi}
...
\lesson{7}{Septième leçon}{Job 17 : 1-3, 11-15}

\gscore{ODEFN3R1}{R}{7}
~\\
\trans{\rr En moi qui pêche chaque jour et n'en fais pas pénitence, la crainte de la mort met le trouble :
...
\lesson{8}{Huitième leçon}{Job 19 : 20-27}
...
\lesson{9}{Neuvième leçon}{Job 10 : 18-22}

\newpage

\rubric{On chante ce répons si l'on a chanté seulement le troisième nocturne.}
\gscore{ODEFN3R3a}{R}{9}
...
\rubric{On chante ce répons si l'on a chanté les trois nocturnes.}
\gscore{ODEFN3R3b}{R}{9}
~\\
...
\addcontentsline{toc}{section}{Laudes}
...
\customseparator{}
%
%\officiumtitulum{À la Messe}
%\addcontentsline{toc}{section}{Messe}
%
%\gscore{MI_in}{in}{}
%\gscore{MI_ky}{}{}
%\gscore{MI_gr}{gr}{}
...
\addcontentsline{toc}{section}{Sépulture des défunts}

\smalltitle{Levée du corps}
\addcontentsline{toc}{subsection}{Levée du corps}
...
\addcontentsline{toc}{subsection}{Enterrement}
...
\gscore{EA1}{A}{}
~\\
\trans{\aa Que les anges te conduisent au paradis ; qu'à ton arrivée les martyrs te reçoivent et t'introduisent dans la cité sainte, Jérusalem.\\
\aa Que le chœur des anges te reçoive, et qu'avec Lazare, le pauvre de jadis, tu jouisses du repos éternel.}\\
~\\
...
\end{parcolumns}
\customseparator{}
{\centering\includegraphics[width=\textwidth]{purgatory.png}\par}
\newpage
\nocturnumtitulum{Psaumes supplémentaires}
\addtocontents{toc}{\vspace{2\baselineskip}}
\addcontentsline{toc}{subsection}{Psaumes supplémentaires à Laudes et Vêpres}
...
\newpage
\nocturnumtitulum{Tons communs}
\addcontentsline{toc}{subsection}{Tons communs}

\smalltitle{Ton des oraisons}

\smallscore[n]{OR_tonusorationis}

\smalltitle{Ton des leçons}

\smallscore[n]{OR_tonuslectionis}
~\\
\rubric{La formule de conclusion s'emploie même lorsque la leçon se termine par un point d'interrogation.}
