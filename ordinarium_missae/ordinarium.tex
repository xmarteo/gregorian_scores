...
\sloppy
\section{Dialogues de l'ordinaire de la messe}
\subsection{(Forme ordinaire, du jour de Pâques à la Pentecôte)}
\paragraph{Ouverture}
\gregorioscore{01or--in_nomine_patris--solesmes.gabc}
\gregorioscore{02or--gratia_domini_nostri_(i)--solesmes.gabc}
\paragraph{Première lecture}
\gregorioscore{or--verbum_domini_(i)--solesmes.gabc}
\paragraph{Deuxième lecture}
\gregorioscore{or--verbum_domini_(ii)--solesmes.gabc}
\paragraph{\'Evangile}
\gregorioscore{or--dominus_vobiscum._..._lectio_sancti_evangelii_(c)--solesmes.gabc}
...
\switchcolumn*
\rr Suscípiat Dóminus sacrifícium de mánibus tuis ad laudem et glóriam Nóminis sui, ad utilitátem quoque nostram, totiúsque Ecclésiæ suæ sanctæ.
\switchcolumn
\rr Que le Seigneur reçoive de vos mains ce
sacrifice
à la louange et à la gloire de son nom,
pour notre bien et celui de toute l’Eglise.
\end{paracol}
\gregorioscore{20or--ante_praefationem_(tonus_sollemnis)--solesmes.gabc}
\newpage
\paragraph{Anamnèse}
\gregorioscore{21or--mortem_tuam_annuntiamus--.gabc}
\paragraph{Notre Père}
\gregorioscore{30or--pater_noster_(a)--solesmes.gabc}
\gregorioscore{32or--pax_domini--solesmes.gabc}
\paragraph{Conclusion}
\gregorioscore{41or--dominus_vobiscum_..._benedicat_(b)--solesmes.gabc}
\gregorioscore{42or--ite_missa_est_alleluia--solesmes.gabc}
