...
%%%%%%%%%%%%%%% GREGORIO CONFIG %%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% BEWARE! THIS PART OF THE FILE IS HEAVILY MODIFIED FOR THE TRIDENTINE PSALTER
%%%%%%%%%%%%%%% IT PRINTS ALL ANTIPHONS WITHOUT EUOUAE BECAUSE THEY ARE ONLY FOR INCIPITS IN THE FERIAL OFFICE
...
\grechangedim{baselineskip}{54pt plus 1pt minus 5pt}{scalable}
...
\newcommand{\postpsalmantiphon}[5][y]{
    %% we temporarily disable mode annotation and replace it with the first line of "anti-phona"
	%% however, we keep mode header capture for indexation purposes
	%% we temporarily redefine the A->Ant correspondence so that it displays the second lien of "anti-phona"
	\gresetheadercapture{mode}{modeindexing}{string}
	{
		\greannotation{\hspace{-3mm}Anti-}
		\renewcommand{\officepartannotation}[1]{phona}
		%% we output the score without the antiphon number
		\gscore[#1]{#2_noeuouae}{#3}{}{#5}
	}
	\gresetheadercapture{mode}{modeannotation}{string}
}

\newcommand{\scoreincipit}[3]{
	\gscore{#1_incipit}{#2}{#3}{}
}
...
\newcommand{\perannumrubric}{\rubric{Per Annum:}}
\let\tprubric\rubrictp
\newcommand{\quadrubric}{\rubric{In Quadragesima:}}
\newcommand{\passrubric}{\rubric{Tempore Passionis:}}
\newcommand{\adventrubric}{\rubric{In Adventu:}}
\newcommand{\rubricextp}{\rubric{Extra Tempus Paschale:}}
\newcommand{\rubricfestextp}{\rubric{In Festis novem Lectionum extra Tempus Paschale:}}
\newcommand{\rubricfesttp}{\rubric{In Festis novem Lectionum Tempore Paschali:}}
\newcommand{\rubricfertp}{\rubric{In Officiis trium Lectionum Tempore Paschali:}}
\newcommand{\rubricotfest}{\rubric{In feriali Officio per Annum, et in Festis extra Tempus Paschale:}}
\newcommand{\rubricferadv}{\rubric{In feriali Officio Adventus:}}
\newcommand{\rubricfertq}{\rubric{In feriali Officio Quadragesimæ:}}
\newcommand{\rubricferpas}{\rubric{In feriali Officio Tempore Passionis:}}
\newcommand{\nonrepetiturrubric}{\rubric{Et non repetitur in Psalmo.}}
\newcommand{\psalmodiapropria}{\rubric{Omnia ut in Psalterio Festivo.}}
\newcommand{\feriaRubric}{\rubric{Omnia de Feria currenti.}}
\newcommand{\CBMVRubric}{\rubric{Invit. et Hymnus de Comm. Beatæ Mariæ Virginis, pag. \pageref{M-CBMV}.}}
\newcommand{\CDEDRubric}{\rubric{Invit. et Hymnus de Comm. Dedicationis, pag. \pageref{M-CDED}.}}
\newcommand{\COPOaRubric}{\rubric{Invit. in tono simplici et Hymnus de Comm. Confessoris, pag. \pageref{M-COPOIa}.}}
\newcommand{\COPObRubric}{\rubric{Invit. in tono festivo et Hymnus de Comm. Confessoris, pag. \pageref{M-COPOIb}.}}
\newcommand{\COPOcRubric}{\rubric{Invit. in tono solemni et Hymnus de Comm. Confessoris, pag. \pageref{M-COPOIc}.}}
\newcommand{\COPOdRubric}{\rubric{Invit. in tono paschali et Hymnus de Comm. Confessoris, pag. \pageref{M-COPOId}.}}
\newcommand{\COPOadRubric}{\rubric{Invit. in tono simplici aut paschali, et Hy. de Comm. Conf., pag. \pageref{M-COPOIb}.}}
\newcommand{\COPObdRubric}{\rubric{Invit. in tono festivo aut paschali, et Hy. de Comm. Conf., pag. \pageref{M-COPOIb}.}}
\newcommand{\COPOcdRubric}{\rubric{Invit. in tono solemni aut paschali, et Hy. de Comm. Conf., pag. \pageref{M-COPOIc}.}}
\newcommand{\PMEXaRubric}{\rubric{Invit. in tono simplici et Hymnus pro pluribus Martyribus, pag. \pageref{M-UMEXIa}.}}
\newcommand{\PMEXbRubric}{\rubric{Invit. in tono festivo et Hymnus pro pluribus Martyribus, pag. \pageref{M-UMEXIb}.}}
\newcommand{\PMTPRubric}{\rubric{Invit. in tono paschali et Hymnus pro pluribus Martyribus, pag. \pageref{M-MRTPI}.}}
\newcommand{\PMEXadRubric}{\rubric{Invit. in tono simplici aut paschali, et Hymnus pro pluribus Martyribus, pag. \pageref{M-UMEXIa}.}}
\newcommand{\UMEXaRubric}{\rubric{Invit. in tono simplici et Hymnus pro uno Martyre, pag. \pageref{M-UMEXIa}.}}
\newcommand{\UMEXbRubric}{\rubric{Invit. in tono festivo et Hymnus pro uno Martyre, pag. \pageref{M-UMEXIb}.}}
\newcommand{\UMEXcRubric}{\rubric{Invit. in tono solemni et Hymnus pro uno Martyre, pag. \pageref{M-UMEXIc}.}}
\newcommand{\UMTPRubric}{\rubric{Invit. in tono paschali et Hymnus pro uno Martyre, pag. \pageref{M-MRTPI}.}}
\newcommand{\UMEXbdRubric}{\rubric{Invit. in tono festivo aut paschali, et Hy. pro uno Martyre, pag. \pageref{M-UMEXIb}.}}
\newcommand{\UMEXadRubric}{\rubric{Invit. in tono simplici aut paschali, et Hy. pro uno Martyre, pag. \pageref{M-UMEXIa}.}}
\newcommand{\MUVNaRubric}{\rubric{Invit. in tono simplici et Hymnus pro Virgine non Martyre, pag. \pageref{M-MUVXIa}.}}
\newcommand{\MUVNbRubric}{\rubric{Invit. in tono festivo et Hymnus pro Virgine non Martyre, pag. \pageref{M-MUVXIb}.}}
\newcommand{\MUVNcRubric}{\rubric{Invit. in tono solemni et Hymnus pro Virgine non Martyre, pag. \pageref{M-MUVXIc}.}}
\newcommand{\MUVNdRubric}{\rubric{Invit. in tono paschali et Hymnus pro Virgine non Martyre, pag. \pageref{M-MUVXId}.}}
\newcommand{\MUVNadRubric}{\rubric{Invit. in tono simplici aut paschali, et Hymnus pro Virgine non Martyre, pag. \pageref{M-MUVXIa}.}}
\newcommand{\MUVNbdRubric}{\rubric{Invit. in tono festivo aut paschali, et Hymnus pro Virgine non Martyre, pag. \pageref{M-MUVXIb}.}}
\newcommand{\MUVMbRubric}{\rubric{Invit. in tono festivo et Hymnus pro Virgine et Martyre, pag. \pageref{M-MUVXIb}.}}
\newcommand{\MUVMaRubric}{\rubric{Invit. in tono simplici et Hymnus pro Virgine et Martyre, pag. \pageref{M-MUVXIa}.}}
\newcommand{\MUNMbRubric}{\rubric{Invit. pro pluribus et Hymnus pro non Virgine, pag. \pageref{M-MUNXIb}.}}
\newcommand{\MUNNaRubric}{\rubric{Invit. pro una et Hymnus pro non Virgine, pag. \pageref{M-MUNXIa}.}}
...
\newcommand{\psalmus}[3][]{
	...
	\twocolitemized{psalmi/psalmi/#2-#3.tex}%
}

\newcommand{\unpointedpsalm}[1]{
    \psalmus{#1}{}
}
...
\newcommand{\psalmustonus}[3][]{
	...
	\twocolitemized{psalmi/psalmi/#2_#3.tex}%
}
...
\newcommand{\feast}[6]{
  ...
  \ifblank{#6}{}{
    {#6}\\% %% in other books this is {\large #6}\\ but we want to save space on the sanctoral.
  }%
  %% the actual title
